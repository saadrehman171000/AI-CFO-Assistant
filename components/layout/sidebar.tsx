...
const navigation = [
  { name: 'Dashboard', href: '/dashboard', icon: BarChart3, requiresSubscription: true, color: 'from-blue-500 to-cyan-500' },
  { name: 'Upload', href: '/upload', icon: Upload, requiresSubscription: true, color: 'from-green-500 to-emerald-500' },
  { name: 'Reports', href: '/reports', icon: FileText, requiresSubscription: true, color: 'from-purple-500 to-pink-500' },
  { name: 'Analytics', href: '/analytics', icon: TrendingUp, requiresSubscription: true, color: 'from-orange-500 to-red-500' },
  { name: 'Forecasting', href: '/forecasting', icon: TrendingUp, requiresSubscription: true, color: 'from-indigo-500 to-purple-500' },
  { name: 'Profile', href: '/profile', icon: User, requiresSubscription: false, color: 'from-gray-500 to-slate-500' },
  { name: 'Subscription', href: '/subscription', icon: CreditCard, requiresSubscription: false, color: 'from-yellow-500 to-orange-500' }
]
  ...
  return (
    <>
      ...
      <div className={cn(
        ...
        "fixed inset-y-0 left-0 z-50 w-64 transform transition-all duration-500 ease-out",
        ...
        <div className="relative h-full">
          ...
          <div className="relative h-full flex flex-col">
            {/* Enhanced 3D Logo */}
            <div className="flex items-center h-20 px-6 border-b border-white/20 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10">
              <Link href="/dashboard" className="flex items-center space-x-3 group" onClick={() => setIsMobileMenuOpen(false)}>
                <div className="relative">
                  ...
                  <div className="relative w-12 h-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl flex items-center justify-center shadow-2xl group-hover:shadow-3xl transition-all duration-300 transform group-hover:scale-110 group-hover:rotate-3">
                    <TrendingUp className="h-6 w-6 text-white" />
                  </div>
                  <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-pink-500 to-orange-500 rounded-full flex items-center justify-center shadow-lg">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500 font-medium">Assistant</div>
                </div>
              </Link>
            </div>
                  ...
                  <div className="relative bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/30">
                    {subscriptionStatus?.hasActiveSubscription ? (
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <span className="text-sm font-bold text-gray-900">Pro Active</span>
                  ...
                  return (
                    <div key={item.name} className="relative group">
                      ...
                      <Link
                        ...
                        className={cn(
                          "relative flex items-center space-x-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-300 transform hover:scale-105",
                          isActive
            ...
            <div className="p-4 border-t border-white/20">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl opacity-40"></div>
                <div className="relative bg-white/80 backdrop-blur-sm rounded-xl p-3 shadow-lg border border-white/30">
                  <div className="text-xs text-gray-500 text-center font-medium">
                    AI CFO Assistant v1.0
                  </div>
                  {isLoading ? (
                    <div className="mt-3 text-center">
                      <div className="animate-pulse bg-gradient-to-r from-gray-200 to-blue-200 h-8 w-full rounded-lg"></div>
                    </div>
                  ) : (
                    !subscriptionStatus?.hasActiveSubscription && (
                      <div className="mt-3 text-center">
                        <Link href="/subscription">
                          <Button size="sm" className="w-full text-xs bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
