      ...
      <div className="relative px-6 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-red-500/20 to-pink-500/20 rounded-xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <Button 
                variant="ghost" 
                size="icon" 
                className="relative bg-white/90 backdrop-blur-sm hover:bg-white hover:shadow-lg transition-all duration-300 transform hover:scale-105"
              >
                <Bell className="h-5 w-5 text-gray-600" />
                <span className="absolute -top-1 -right-1 h-3 w-3 bg-gradient-to-r from-red-500 to-pink-500 rounded-full shadow-lg animate-pulse"></span>
              </Button>
            </div>
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  <UserButton 
                    appearance={{
                      elements: {
                        userButtonAvatarBox: "w-10 h-10 sm:w-12 sm:h-12 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105",
                        userButtonPopoverCard: "shadow-2xl border border-white/30 bg-white/95 backdrop-blur-xl",
                        userButtonPopoverActionButton: "hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition-all duration-200",
                      }
                    }}
                  />
                </div>
